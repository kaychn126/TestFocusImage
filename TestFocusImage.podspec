#
#  Be sure to run `pod spec lint EZBSGFocusImage.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "ChenKai" => "kaychn@126.com" }
  # Or just: s.author    = "ChenKai"
  # s.authors            = { "ChenKai" => "kaychn@126.com" }
  # s.social_media_url   = "http://twitter.com/ChenKai"
